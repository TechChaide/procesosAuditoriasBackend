...
module.exports = {
    ...
    createOrUpdate: async (req, res) => {
        try {
            ...
            if (codigo_pregunta == 0 || codigo_pregunta === undefined) {
                // Create new record
                const newRecord = await Pregunta.create({
                ...
                const response = await Pregunta.findByPk(newRecord.codigo_pregunta);
                ...
                const record = await Pregunta.findByPk(codigo_pregunta);
                ...
                // Update fields
                if (descripcion_pregunta !== undefined) record.descripcion_pregunta = descripcion_pregunta;
                ...
                const updatedRecord = await Pregunta.findByPk(codigo_pregunta);
    ...
    getById: async (req, res) => {
        try {
            ...
            const record = await Pregunta.findByPk(id);
